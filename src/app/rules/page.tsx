  ...
  return (
    <div>
          ...
          <div className="p-8">
            ...
            <p className="urdu text-right text-lg">اگر مرحوم کے بچے کی عمر ایک سال یا اس سے زیادہ ہو، تو کمیٹی کی جانب سے کھانے پینے کے انتظام کے لیے مکمل رقم فراہم کی جائے گی۔</p>
          </div>
    </div>
  )
}
